...
<body>
 ...
 <div class="container-fluid">
   <div class="row">
     ...
     <h2 style="display:inline-block">数据库列表</h2>
      ...
      <div class="modal-body">
        	<form class="form-horizontal">
				 ...
				 <!--  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" id="dbnameInputNew">
				    </div>
				  </div> -->
			</form>
      </div>
...
function addSub(){
	 if($("#titleInputNew").val() == "" || $("#IPInputNew").val() == ""
			|| $("#portInputNew").val() == ""/* || $("#dbnameInputNew").val() == "" */){
		$(".modal-footer span").html("请将数据填写完整");
		return;
		}
	   //保存信息
	   $.ajax(
			{url:"${pageContext.request.contextPath}/backend/savedb",
				type:"post",
				dataType:"json",
				data:{
